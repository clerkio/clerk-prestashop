...
class ProductHelper {
    ...
    public static function buildData($context, $shop_id, $language_id, $product_id, $product = null, $product_stock = null){
        ...
        // Iterate over product data and regex replace all keys to remove cyrillic chars

        $fproduct_data = [];
        foreach ($product_data as $key => $value) {
          $fproduct_data[ProductHelper::transliterateKey($key)] = $value;
        }

        return $fproduct_data;

    }

    public static function transliterateKey($key) {
      ...
      return str_replace($cyr, $lat, $key);
    }
}
